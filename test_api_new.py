...
Tests all endpoints: health, login, predict, and predict_batch
"""
...
class APITester:
    ...
    def test_predict(self) -> bool:
        ...
        try:
            ...
            response = self.session.post(f"{self.base_url}/predict", json=predict_data)
    ...
    def test_predict_batch(self) -> bool:
        ...
        try:
            ...
            response = self.session.post(f"{self.base_url}/predict_batch", json=batch_data)
    ...
    def test_unauthorized_access(self) -> bool:
        ...
        try:
            ...
            if data.get("status") == "error" and "token" in data.get("error", "").lower():
                print("✅ Unauthorized access properly blocked!")
                return True
            else:
                print(f"❌ Unauthorized access not properly handled: {data}")
                return False
    ...
    def test_invalid_credentials(self) -> bool:
        ...
        try:
            ...
            if data.get("status") == "error" and "invalid" in data.get("error", "").lower():
                ...
                print(f"❌ Invalid credentials not properly handled: {data}")
                return False
...
def main():
    """Main test function"""
    print("🧪 Student Admission Prediction API - Test Suite")
    print("=" * 60)
    ...
    for base_url in base_urls:
        ...
        print("   bentoml serve src/api_service.py:service --reload")
